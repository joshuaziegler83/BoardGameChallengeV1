namespace BoardGameChallengeV1.Data.Migrations
{
    ...
    public partial class initCreate : DbMigration
    {
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.BoardGame", "UserId", "dbo.ApplicationUser");
            DropForeignKey("dbo.IdentityUserRole", "ApplicationUser_Id", "dbo.ApplicationUser");
            DropForeignKey("dbo.IdentityUserLogin", "ApplicationUser_Id", "dbo.ApplicationUser");
            DropForeignKey("dbo.Message", "UserId2", "dbo.ApplicationUser");
            DropForeignKey("dbo.Message", "UserId1", "dbo.ApplicationUser");
            DropForeignKey("dbo.FriendRequest", "UserId2", "dbo.ApplicationUser");
            DropForeignKey("dbo.FriendRequest", "UserId1", "dbo.ApplicationUser");
